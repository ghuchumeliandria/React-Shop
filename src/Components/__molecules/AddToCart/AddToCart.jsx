...
function AddToCart() {
  return (
    <>
      <div className="w-full max-w-[445px] flex flex-col ">
        <div className="flex flex-col gap-8">
          <h2 className="text-mainorange font-KumbhBold tracking-[2px] mb-[-11px]">
            Sneaker Company
          </h2>
          <h1 className="text-[44px] font-KumbhBold leading-12">
        ...
        <div className="flex flex-col gap-2.5 font-KumbhBold mt-7">
        ...
        <div className="flex gap-4 mt-8">
          <div className="flex justify-between px-4 py-4.5 w-[157px] bg-[#F6F8FD] rounded-[10px] ">
            <button className=" cursor-pointer">
              <img src={minus} alt="" />
            </button>
            <p className="font-KumbhBold">0</p>
            <button className=" cursor-pointer">
              <img src={plus} alt="" />
            </button>
          </div>
          <div className="w-[272px] ">
            <button className="w-full pt-[23px] pb-[17px] bg-mainorange flex justify-center gap-4 items-center rounded-[10px] h-[56px] cursor-pointer">
              <svg
